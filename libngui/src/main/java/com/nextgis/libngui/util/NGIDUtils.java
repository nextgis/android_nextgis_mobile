...
{
    private static final String OAUTH_NEW     =
            "https://my.nextgis.com/oauth2/token/?grant_type=password&username=%s&password=%s&client_id=%s";
    private static final String OAUTH_REFRESH =
            "https://my.nextgis.com/oauth2/token/?grant_type=refresh_token&client_id=%s&refresh_token=%s";
        ...
        protected String doInBackground(String... args)
        {
            ...
            if (userCheck == null) {
                ...
                String accessRefresh =
                        String.format(OAUTH_REFRESH, BuildConfig.CLIENT_ID, refreshToken);
    ...
    private static void saveUserInfo(String userInfo)
    {
        try {
            ...
            mPreferences.edit()
                    .putString(PREF_USERNAME, json.getString(PREF_USERNAME))
